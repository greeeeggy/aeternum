// lib/class_schedule/add_class_dialog.dart
...
class AddClassDialog extends StatefulWidget {
  ...
  const AddClassDialog({super.key, this.activeGroupId});
...
class _AddClassDialogState extends State<AddClassDialog> {
  ...
  bool _validateTimes() {
    ...
    // Check if overlaps with lunch (12:00 PM - 1:00 PM)
  ...
  Future<bool> _checkForOverlap() async {
    ...
    final dayClasses = allClasses.where((c) =>
      c.dayOfWeek == _selectedDay &&
      c.groupId == widget.activeGroupId
    ).toList();
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            const SizedBox(width: 12),
                            const Text('Tap to choose color', style: TextStyle(color: Colors.white)),
                          ],
                        ),
